  ...
  <div id="about-page" class="page-wrapper about-page content-page">
    ...
    <main-section theme="sidebar-right">
      <template v-slot:default>
        <div class="content">
          <h3>Remade Foods is dedicated to providing the world with reimagined recipes using leftovers.</h3>
          <p>
          </p>
          <p>
            Growing up we didn't have much. Our parents would always push us to finish everything on our plates. They would go so far as say that for every grain of rice we did not finish there would be a new pimple on our face in the morning. I remember there was one night I did not want to eat my vegetables for dinner and cunningly slipped them into the garbage can with other wrappers and "garbage" placed on top. About 10 minutes later my dad runs over screaming at me saying that I should not have wasted food! All I could do was sit and contemplate how on earth he found my hidden veggies.
<p>
</p>
